...
| 明文 digraph | 字母 1 (row,col) | 字母 2 (row,col) | 规则 | 密文 digraph |
| ---------- | -------------- | -------------- | -- | ---------- |
| HE         | H (2,4)        | E (1,2)        | 矩形 | DM         |
| LX         | L (0,1)        | X (1,3)        | 矩形 | YR         |
| LO         | L (0,1)        | O (3,2)        | 矩形 | AN         |
| WO         | W (4,3)        | O (3,2)        | 矩形 | VQ         |
| RL         | R (1,1)        | L (0,1)        | 同列 | CR         |
| DX         | D (2,2)        | X (1,3)        | 矩形 | GE         |
最后得到的结果就是`DM YR AN VQ CR GE`
